...
**classDiagram
  ...
  IssuesPage --> IssueForm
  IssuesPage --> IssueCard
  IssuesPage --> StatsOverview
  IssuesPage --> UseIssuesAPI

  DashboardPage --> Header
  DashboardPage --> UseIssuesAPI

  IndexPage --> Header
  IndexPage --> IssueForm
  IndexPage --> IssueCard
  IndexPage --> StatsOverview
  IndexPage --> UseIssuesAPI

  AIPage --> Header
  AIPage --> UseIssuesAPI
  AuthPage --> AuthContext
  PaymentPage --> AuthContext
  SettingsPage --> AuthContext

  UseIssuesAPI --> IssuesContext
  IssuesContext --> APIService
  AuthContext --> APIService
  AuthContext --> FirebaseClient
  APIService --> FirebaseClient**
